    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtUtil jwtUtil, UserDetailsService userDetailsService) throws Exception {
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/admin/routes/**").hasAnyRole("ADMIN", "SUPER_ADMIN","PRINCIPAL","STUDENT")
                        .requestMatchers("/api/buses/student-assignment/**").hasAnyRole("STUDENT", "ADMIN", "SUPER_ADMIN", "PRINCIPAL")
                        .requestMatchers("/api/buses/**").hasAnyRole("ADMIN", "SUPER_ADMIN","PRINCIPAL","STUDENT")
